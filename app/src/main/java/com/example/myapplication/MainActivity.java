...
public class MainActivity extends AppCompatActivity {
    ...
    EditText firstname_edit, lastname_edit, email_edit, phonenumber_edit, address_edit,  city_edit, zipcode_edit, age_edit, Password_edit;
    ImageView date_icon;
    TextView date,check_text;
    Spinner occupation_spinner, country_spinner,state_spinner;
    CheckBox ch;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        state_spinner = findViewById(R.id.state_edit);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ch.isChecked()) {
                    ...
                    data = new FormModel();//default constructor
    ...
    private boolean CheckAllFields() {
        ...
        if (Password_edit.getText().toString().isEmpty()) {
            ...
            return false;
        } else if (!Password_edit.getText().toString().matches(".*[!@#$%^&*()_+=\\-\\[\\]{};':\"\\\\|,.<>/?].*")) {
        ...
        if (state_spinner.getSelectedItem().toString().isEmpty()) {
