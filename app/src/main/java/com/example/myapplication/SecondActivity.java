...
public class SecondActivity extends AppCompatActivity {
    ...
    TextView First_Name, Last_Name, Email, Password, PhoneNumber, Address, zipcode, country, date_of_birth, occupation, city, state, age, gender, maritalStatus;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        data = (FormModel) getIntent().getSerializableExtra("Details");
